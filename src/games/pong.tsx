    ...
    <main className="relative z-10 flex-1 min-h-0 flex flex-col items-center w-full max-w-[920px] mx-auto px-2 sm:px-4 gap-2 sm:gap-3 pt-2 sm:pt-3">
      ...
      >
        ...
        <div className="flex items-center gap-2 bg-pit/90 border border-line rounded-md px-3 py-2">
          <span className="font-display text-[8px] tv:text-xs text-fog tracking-wider">TARGET</span>
        ...
        >
          ...
          {hud.phase === "idle" && (
            <div data-menu className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-3 sm:gap-4 bg-[rgba(3,10,6,0.9)] animate-rise p-4 overflow-y-auto">
              ...
              <p className="text-fog text-sm tv:text-xl text-center max-w-[260px] leading-relaxed">
          ...
          {hud.phase === "paused" && (
            <div data-menu className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-3 sm:gap-4 bg-[rgba(3,10,6,0.86)] animate-rise p-4">
              ...
              <p className="text-fog text-sm tv:text-xl -mt-1">The ghost gets nervous…</p>
            ...
            <div data-menu className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-3 sm:gap-4 bg-[rgba(3,10,6,0.88)] animate-rise p-4 overflow-y-auto">
              ...
              <div className="flex items-center gap-2 text-center">
                <div className="bg-pit/80 border border-line rounded-md px-3 py-2">
                  <p className="text-[8px] tv:text-xs font-display text-fog mb-1">YOU</p>
                  <p className="font-display text-xs text-lime tabular-nums">{hud.l}</p>
                </div>
                <div className="bg-pit/80 border border-line rounded-md px-3 py-2">
                  <p className="text-[8px] tv:text-xs font-display text-fog mb-1">GHOST</p>
      ...
      {isTouch ? (
        ...
        <div className="shrink-0 pb-2 sm:pb-3 text-center">
          <p className="text-[11px] tv:text-lg text-fog/85 flex items-center justify-center gap-x-2 gap-y-1 flex-wrap">
            Hold <span className="keycap">↑</span><span className="keycap">↓</span> or{" "}
            <span className="keycap">W</span><span className="keycap">S</span> to move ·{" "}
            <span className="keycap">R</span> restart · <span className="keycap">P</span> pause ·{" "}
      ...
      <LeaderboardModal
        ...
        label="VS GHOST"
        labelColor="#ff6257"
        myScore={hud.phase === "over" ? hud.l : 0}
      />
    </main>
  );
}
